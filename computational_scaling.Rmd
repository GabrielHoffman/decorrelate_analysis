...
fig = res %>% 
	...
	ggplot(aes(p, value, color=Method)) + 
		...
		geom_smooth() +
		scale_color_manual(name="Method", values = c(naive = "green4",  decorrelate = "red",  low_rank = "#9f1214")) + 
		ggtitle("n = 5000")
...
fig = res %>% 
	...
	ggplot(aes(p, value, color=Method)) + 
		...
		geom_smooth() +
		scale_color_manual(name="Method", values = c(naive = "green4",  decorrelate = "#E41A1C",  low_rank = "#9f1214")) + 
		ggtitle("n = 5000")
