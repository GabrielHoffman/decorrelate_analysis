...
values = as.integer(sort(c(	seq(500, 20000, length.out=10))))

df_values = data.frame(n = 5000, p = values, k = 50)

df_time = eval_runTime( df_values, 5000, ncores=4 )
...
fig3 = fig + scale_x_log10() + xlab(bquote(Number~of~features~(log[10]))) + ylab(bquote(Time~(seconds)))
